...
namespace Niem.Fips64.v20
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://niem.gov/niem/fips_6-4/2.0", TypeName="USCountyCodeSimpleType")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://niem.gov/niem/fips_6-4/2.0", IsNullable=false, ElementName="USCountyCodeSimpleType")]
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://niem.gov/niem/fips_6-4/2.0", TypeName="USCountyCodeType")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://niem.gov/niem/fips_6-4/2.0", IsNullable=true, ElementName="USCountyCodeType")]
    
    public partial class USCountyCodeType : object 
    {
        ...
        /// <remarks/>
        private USCountyCodeSimpleType value;
        
        public USCountyCodeType()
        {
        }
        
        public USCountyCodeType(string id, string metadata, string linkMetadata, USCountyCodeSimpleType value)
        {
            this.id = id;
